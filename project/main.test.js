import { capitalize, reverseStr, calculator, caesar, arrayAnalysis } from "./main";
...
describe("AnalyzeArray test cases: ", ()=>{
    test(" analyzeArray of [1,8,3,4,2,6] should be object == average: 4, min: 1, max: 8, length: 6", ()=>{
